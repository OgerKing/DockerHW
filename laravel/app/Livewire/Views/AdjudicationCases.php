...
class AdjudicationCases extends Component
{
    ...
    {
        // $query = Adjudication::with('adjudicationCourts.court', 'AdjudicationStatus', 'Bureau')->orderBy('adjudication_name', 'asc'); TODO: previously had relationship with adjudicationCourts
        $query = Adjudication::with('AdjudicationStatus', 'Bureau')->orderBy('adjudication_name', 'asc');;
        ...
        $this->adjudications = $query->take(100)->get();
