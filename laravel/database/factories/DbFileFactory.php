...
class DbFileFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'basin_user_id' => BasinUser::factory(),
            'bureau_id' => Bureau::factory(),
            'court_id' => Court::factory(),
            'created_by' => $this->faker->regexify('[A-Za-z0-9]{64}'),
            'db_id' => $this->faker->randomNumber(),
            'db_id_access' => $this->faker->randomNumber(),
            'nbr' => $this->faker->regexify('[A-Za-z0-9]{5}'),
            'program_id' => Program::factory(),
            'suffix' => $this->faker->regexify('[A-Za-z0-9]{5}'),
